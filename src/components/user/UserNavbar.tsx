  ...
  useEffect(() => {
     window.addEventListener("scroll", () => {
       ...
       if(window.scrollY > 10 ){
         navRef.current?.classList.add("darker")
         navRef.current?.classList.remove("c-bg")
       }else{
        navRef.current?.classList.remove("darker")
        navRef.current?.classList.add("c-bg")
       }
     })
  }, [])
    ...
    <>
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
           <div className="modal-content darker main-bg rounded-lg shadow-lg">
            <div className="modal-header">
            <h5 className="modal-title text-bold uppercase text-[#7450fe]">
                Access Code 
              </h5>
        ...
        <form onSubmit={handleSubmit1}>
          ...
          <button disabled={accessCodeInfo.isSubmitting}  className=" tracking-wide font-semibold bg-gradient-to-r hover:bg-gradient-to-l from-[#21d397] to-[#7450fe] text-white w-full py-3 rounded-lg  transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none" type="submit">
           {accessCodeInfo.isSubmitting ? "Submitting..." : "Submit"}
            ...
            <div className="w-full   font-light">
              ...
              <button
                ...
                className=" tracking-wide font-semibold cmn--btn text-white w-full rounded-lg py-3 px-2 bg-gradient-to-r hover:bg-gradient-to-l from-[#21d397] to-[#7450fe]  transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
                onClick={() => {
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="userTextColor mt-3">   37GUcvSwbzRaMRQzVX83bdzKQSjoFjCqJS</p>
        </div>
        ...
        <form onSubmit={handleSubmit2}>
          ...
          <button  className=" tracking-wide font-semibold text-white w-full py-3 px-2 bg-gradient-to-r hover:bg-gradient-to-l from-[#21d397] to-[#7450fe] rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none" type="submit" disabled={accessCodeProve.isSubmitting}>
      ...
      <nav ref={navRef} className="py-[0.9px] c-bg fixed-top top-0  px-0 lg:px-2 shadow-lg z-20">
        <div className="container max-w-full mx-auto flex items-center justify-between md:pr-8 md:pl-10">
          <div className="flex justify-between items-center w-full ">
            <div className="flex justify-center lg:ml-6 ml-0 items-center w-[100px] h-[100px]">
              <Image height={50} width={50}  src="/assets/img/logo.png" alt="logo" />
              <span className="text-white hidden lg:inline ml-1">
                Cryptoguarantee
                </span>
            </div>
            <div className="flex justify-center gap-2 items-center">
              <div>
                ...
                <IconM.MdFullscreen className='text-white' size={30}/>

                </span>
              </div>
              <div className="dropdown cursor-pointer relative">
                {notifications.length > 0 && (
                  <span className="w-4 h-4 flex text-white text-xs justify-center items-center rounded-full absolute bg-gradient-to-r from-[#21d397] to-[#7450fe] hover:gradient-to-l">
                ...
                />
                <div
                  className="dropdown-menu dropdown-menu-right overflow-y-auto min-h-full shadow-2xl darker "
                ...
                >
                  ...
                  {notifications?.length > 0 ? (
                    notifications.map((each) => (
                      <div
                        key={each.id}
                        className="dropdown-item py-2 bg-transparent hover:bg-gradient-to-l from-[#21d397] to-[#7450fe] border-b "
                      >
                        <span className="text-white  text-sm-wrap">
                          {each.text}
                        </span>
                        <p className="text-muted text-sm mt-0.5 hover:text-white">
                    ...
                    <p className=" dropdown-item bg-transparent  text-[#e36715]">
                      No notification
                    </p>
                  )}
                  {notifications?.length > 0 && (
                    <span onClick={handleNotificationClear} className="dropdown-item hover:bg-transparent transition-color duration-500 ease-linear text-[#e36715] hover:text-red-700 text-center">
                      clear All
                    </span>
                  )}
                </div>
              ...
              <div className="dropdown">
                <Image
                  width={40}
                  height={40}
                  src={userDocument?.photo || "/assets/imgs/avater.png"}
                  className="dropdown-toggle !w-11 !h-11 rounded-full cursor-pointer "
                  id="dd-drop"
                ...
                <div
                  className="dropdown-menu  darker "
                  area-aria-labelledby="dd-drop"
                >
                  <li className="dropdown-item hover:bg-gradient-to-l from-[#21d397] to-[#7450fe] transition-colors ease-linear duration-500 ">
                    <Link
                  ...
                  <li
                    className=" text-white dropdown-item hover:bg-gradient-to-l from-[#21d397] to-[#7450fe] transition-colors ease-linear duration-500 "
