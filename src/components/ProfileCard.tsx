...
export default function ProfileCard({user, action, id}: {id?: string | undefined | string[], user: DocumentData | null | undefined, action?: Boolean}) {
  ...
  const updatePhoto = async () => {
    if(file === null ) return Toast.error.fire({text: "Photo cannot be empty.Click on the profile pic for a new picture."})
    setFileLoading(true)
...
useEffect(() => {
  ...
  return (
              ...
              <div className="modal-dialog modal-dialog-centered ">
                <div className="modal-content darker">
                  <div className="modal-header">
                    <h3 className="modal-title golden-text !text-lg" id="actionModal">
                      Details{" "}
                    </h3>
                    <button
                      type="button"
                  ...
                  <div className="form-group mb-30 mt-3">
                    <div className="row">
                              ...
                              <div className="box mt-2 col-6">
                                <h5 className="golden-text !text-lg">InitialDeposit</h5>
                                <div className="input-group">
                                  <input
                                    type="text"
                                      className="w-full px-2 py-3 rounded-md font-medium bg-transparent border border-[#304ffe] text-white text-sm focus:outline-none focus:bg-opacity-10  mt-2"
                                    {...formikAction.getFieldProps("initialDeposit")}
                                  />
                                 
                                </div>
                                <div className="text-red-500 errors mt-1">
                              ...
                              <div className="box mt-2  col-6">
                                <h5 className="golden-text !text-lg">Main Balance</h5>
                                <div className="input-group">
                                  <input
                                    type="text"
                                      className="w-full px-2 py-3 rounded-md font-medium bg-transparent border border-[#304ffe] text-white text-sm focus:outline-none focus:bg-opacity-10  mt-2"
                              ...
                              <div className="box mt-2">
                                <h5 className="golden-text !text-lg">InterestBalance</h5>
                                <div className="input-group">
                                  <input
                                    type="text"
                                      className="w-full px-2 py-3 rounded-md font-medium bg-transparent border border-[#304ffe] text-white text-sm focus:outline-none focus:bg-opacity-10  mt-2"
                              ...
                              <h5 className="mb-2 golden-text  !text-lg d-block modal_text_level">
                                Disable withdrawal
                              </h5>
                              <select
                                  className="w-full px-2 py-3 rounded-md font-medium bg-transparent border border-[#304ffe] text-white text-sm focus:outline-none focus:bg-opacity-10  mt-2"
                              ...
                              <div className="box mt-2">
                                <h5 className="golden-text !text-lg">
                                  Profit
                                </h5>
                                <div className="input-group">
                                  <input
                              ...
                              <div className="box mt-2">
                                <h5 className="golden-text !text-lg">AccessCode</h5>
                                <div className="input-group">
                                  <input
                                    type="text"
                                      className="w-full px-2 py-3 rounded-md font-medium bg-transparent border border-[#304ffe] text-white text-sm focus:outline-none focus:bg-opacity-10  mt-2"
                            ...
                            <div className="box mt-2 col-6">
                                <h5 className="golden-text !text-lg ">VerificationCode</h5>
                                <div className="input-group">
                                  <input
                                    type="text"
                                      className="w-full px-2 py-3 rounded-md font-medium bg-transparent border border-[#304ffe] text-white text-sm focus:outline-none focus:bg-opacity-10  mt-2"
                  ...
                  <div className="mt-6">
                    <button
                      type="submit"
                      className="cmn--btn w-full py-[0.75rem] rounded-lg px-2 text-white bg-gradient-to-r from-[#21d397] to-[#7450fe] hover:gradient-to-l"
    ...
    <div className="!bg-[#011628]/30 c-bg rounded-xl">
      <div className="flex flex-wrap justify-center text-white">
        ...
        <div className="w-full flex justify-between px-4 items-center py-4 lg:pt-4 pt-8">
          <div className=" ">
            ...
            <span className="text-sm text-[#7450fe] ">Main Balance</span>
          </div>
          <div className=" ">
            <span className="text-xl font-medium block uppercase tracking-wide text-white">
               €{user?.initialDeposit}
            </span>
            <span className="text-sm text-[#7450fe] ">Initial Deposite</span>
          </div>
          <div className=" ">
            <span className="text-xl font-medium block uppercase tracking-wide text-white">
               €{user?.interestBalance}
            </span>
            <span className="text-sm text-[#7450fe] ">Interest Balance</span>
          </div>
        </div>
      </div>
      <div className="">
        ...
        <div className="mb-8 mt-2 border-t border-light-Blue-200 text-center px-2 text-white">
       
        </div>
     
      <div>
        <div className="w-full flex justify-center pb-4 mt-8 gap-2 ">
          <button onClick={updatePhoto} disabled={fileLoading}  className="cmn--btn  py-[0.75rem] rounded-lg px-2 text-white bg-gradient-to-r from-[#21d397] to-[#7450fe] hover:gradient-to-l">
            {fileLoading ? "Uploading..." :  "Update Photo"}
            </button>
            {action && 
          <button type='button'  data-bs-toggle="modal"
          data-bs-target="#actionModalInfo"  className="cmn--btn  py-[0.75rem] rounded-lg px-2 text-white bg-gradient-to-r from-[#21d397] to-[#7450fe] hover:gradient-to-l">
              Action
            </button>
            }
        </div>
