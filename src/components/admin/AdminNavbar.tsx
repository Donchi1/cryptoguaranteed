...
useEffect(() => {
  ...
  return (
    <>
           ...
           {accessCodeInfo.isSubmitting ? "Submitting..." : "Submit"}
            ...
            <div className="w-full   font-light">
              ...
              <button
                ...
                className=" d font-semibold bg-red-500 text-white w-full py-3 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
                onClick={() => {
      ...
      <nav ref={navRef} className="c-bg sticky top-0  px-0 lg:px-2 shadow-lg z-20">
        <div className="container max-w-full mx-auto flex items-center justify-between md:pr-8 md:pl-10">
          <div className="flex justify-between items-center w-full ">
            ...
            <div className="flex justify-center gap-2 items-center">
              <div>
                <span ref={screenRef} className="cursor-pointer text-white hidden d-lg-inline rounded-xl bg-transparent">
              ...
              <div className="dropdown cursor-pointer relative">
                {notifications.length > 0 && (
                  <span className="w-4 h-4 flex text-xs justify-center items-center rounded-full absolute text-white bg-[#7450fe]">
                ...
                />
                <div
                  className="dropdown-menu dropdown-menu-right overflow-y-auto sidebar-scroll dropdown-height darker"
                ...
                >
                  ...
                  {notifications?.length > 0 ? (
                    notifications.map((each) => (
                      <div
                        key={each.id}
                        className="dropdown-item py-2 bg-transparent hover:bg-gradient-to-l hover:from-[#21d397] hover:to-[#7450fe] border-b "
                      >
              ...
              <div className="dropdown">
                ...
                <div
                  className="dropdown-menu bg--gradient darker"
                  area-aria-labelledby="dd-drop"
                >
                  <li className="dropdown-item hover:bg-gradient-to-l hover:from-[#21d397] hover:to-[#7450fe]  transition-colors ease-linear duration-500 ">
                    <Link
                  ...
                  <li
                    className=" text-white dropdown-item hover:bg-gradient-to-l hover:from-[#21d397] hover:to-[#7450fe]  transition-colors ease-linear duration-500 "
