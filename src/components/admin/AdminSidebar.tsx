...
const  AdminSidebar = ()=> {
  ...
  return (
    <>
      ...
      >
        <div className={`h-[87%] fixed sidebar-scroll shadow-2xl  ${showSidebar ? "w-[50%] bg--gradient darker" : "w-[25%]  bg-[#011628]/30 c-bg "}`}>
          <div
            ...
            <div className="flex-col items-stretch min-h-full flex-nowrap px-0 ">
                ...
                <div className="flex justify-center flex-col items-center  gap-2">
                  ...
                  <div className="flex flex-col gap-1 mt-2">
                    <h6 className="text-lg font-[600]">
                      Welcome:{" "}
                      <span className="text-lg text-[#7450fe]  font-normal">
              ...
              {/* <div className="flex gap-4 justify-center items-center mt-2">
                ...
                <button
                  ...
                  className="  bg-red-500 text-white shadow-md p-2 rounded-md  outline-none hover:bg-[#e36715] transition-colors "
                >
                  Transfer
                </button>
              </div> */}
              <div className="flex flex-col">
                ...
                <ul className="flex-col min-w-full flex list-none">
                  ...
                  <li className=" bg-gradient-to-r hover:bg-gradient-to-l from-[#21d397] to-[#7450fe]  px-4 rounded-md text-white mb-6">
                    <Link
