 ...
 useEffect(() => {
  ...
  const handleSubmit = async(value: userUpdateType) => {
      ...
      try {
        ...
        return Toast.success.fire({ text: "update success" });
      } catch (err : any) {
        formik.setSubmitting(false);
  ...
  return (
    <div className="!bg-[#011628]/30 p-4 rounded-xl c-bg">
     
      <div>
        <form onSubmit={formik.handleSubmit}>
          <h6 className="text-[#7450fe] text-xl mt-3 mb-3 font-light uppercase">
            User Information
          </h6>
          <div className="row ">
              ...
              <input
                ...
                />
                 {formik.touched.phone &&
                        formik.errors.phone? (
                          <div className="text-[#7450fe] mb-2 mt-2">
                            {formik.errors.phone}
                          </div>
                        ) : null}
            </div>
          ...
          <h6 className="text-[#7450fe] text-xl mb-3 mt-2 font-light uppercase">
            Contact Information
          </h6>
          <div className="row ">
          ...
          <h6 className="text-[#7450fe] text-xl  font-light uppercase">
            About Me
          </h6>
          ...
          <div className="flex flex-wrap  font-light my-5">
            <button
              type="submit"
        ...
        <form onSubmit={formikPass.handleSubmit}>
          <h6 className="text-[#7450fe] text-xl my-6 font-light uppercase">
            Password
          </h6>
          <div className="row ">
