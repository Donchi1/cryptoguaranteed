...
export default function Dashboard() {
  ...
  return (
    ...
    <div className="footer-bg flex-[3] homepage-3">
      <div className=" px-3 md:px-8 h-20 pt-10 " />

      <div className="px-3 md:px-8">
        <div className=" container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-1 lg:gap-7 mb-4 text-white">
            <StatusCard
              color="red"
              icon="money"
              title="Initial"
      ...
      <div className=" px-3 md:px-4">
        <div className="container mx-auto ">
          <div className="grid grid-cols-1 xl:grid-cols-4">
            <div className="xl:col-start-1 xl:col-end-3  lg:px-4 mb-14">
              <ChartLine />
            </div>
            <div className="xl:col-start-3 xl:col-end-6 lg:px-4 mb-14">
              <ChartBar />
            </div>
          </div>
        </div>
